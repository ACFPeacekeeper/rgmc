...
class AffectGRUEncoder(torch.nn.Module):
    ...
    def set_latent_dim(self, latent_dim):
        self.latent_dim = latent_dim
        self.projector = nn.Linear(self.hidden_dim*self.ts, latent_dim)
...
class AffectEncoder(LightningModule):
    ...
    def set_latent_dim(self, latent_dim):
        self.latent_dim = latent_dim
        self.encode = nn.Linear(self.common_dim, latent_dim)

    def set_common_dim(self, common_dim):
        self.common_dim = common_dim
        self.encode = nn.Linear(common_dim, self.latent_dim)
